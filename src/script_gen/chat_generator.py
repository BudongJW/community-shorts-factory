...
### 1. 훅 (첫 번째 메시지가 가장 중요!)
- 첫 메시지는 반드시 스크롤을 멈추게 만드는 훅이어야 한다
- 훅 공식: 질문형 / 충격적 주장 / 호기심 유발 / 논쟁 촉발
- 예: "야 이거 실화냐?", "방금 팀장이 한 말 ㄹㅇ 소름", "이런 회사 정상임?"
- 절대 평범하게 시작하지 마라 ("안녕" "뭐해" 같은 인사 금지)

### 2. 루핑 구조 (끝이 다시 시작으로 연결)
- 마지막 메시지나 result_text가 첫 메시지의 내용을 다시 떠올리게 해야 한다
- YouTube는 영상 반복 재생을 각각 별도 조회수로 카운트한다
- 예: 첫 메시지 "이 회사 정상임?" -> 마지막 result_text "결론: 비정상 ㅋㅋ"

### 3. 분량 최적화
- 메시지 수: 8~12개 (20~25초 영상이 완주율 최적)
- 각 메시지는 1~2줄 (최대 30자) - 더 짧게, 더 임팩트 있게
- 불필요한 인사/부연 삭제. 매 메시지가 정보나 반응을 담아야 함
...
- 주제에 맞는 자연스러운 이름 (예: "글쓴이", "댓글러", "지나가던 형")

### result_text
- 대화의 결론/반전을 한 줄로 요약 (15자 이내)
- 첫 메시지의 훅과 연결되어야 함 (루핑 구조)
...
{{
  "category": "커뮤니티 썰",
  "title": "제목 (호기심 유발, 핵심 키워드 앞배치, 15자 이내)",
  "subtitle": "디시인사이드 HIT 갤러리",
  "participants": ["참가자1", "참가자2"],
  "messages": [
    {{"sender": "참가자1", "text": "훅! 스크롤 멈추는 첫 메시지", "side": "left"}},
    {{"sender": "참가자2", "text": "반응", "side": "right"}}
  ],
  "result_text": "훅과 연결되는 결론",
